/*
  ...
  - You are about to drop the `_BaseCurrency` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "_BaseCurrency" DROP CONSTRAINT "_BaseCurrency_A_fkey";

-- DropForeignKey
ALTER TABLE "_BaseCurrency" DROP CONSTRAINT "_BaseCurrency_B_fkey";

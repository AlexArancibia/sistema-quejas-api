...
-- AlterTable
ALTER TABLE "City" ALTER COLUMN "id" SET DEFAULT 'city_' || substr(gen_random_uuid()::text, 1, 8);
...
-- AlterTable
ALTER TABLE "Country" ALTER COLUMN "id" SET DEFAULT 'country_' || substr(gen_random_uuid()::text, 1, 8);
...
-- AlterTable
ALTER TABLE "ShippingMethod" ADD COLUMN     "availableDays" TEXT[] DEFAULT ARRAY['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun']::TEXT[],
ADD COLUMN     "cutOffTime" TEXT,
ADD COLUMN     "maxDeliveryDays" INTEGER,
ADD COLUMN     "minDeliveryDays" INTEGER,
ADD COLUMN     "minWeight" DECIMAL(65,30) DEFAULT 0,
ALTER COLUMN "id" SET DEFAULT 'sm_' || substr(gen_random_uuid()::text, 1, 13);

-- AlterTable
ALTER TABLE "ShippingMethodPrice" ADD COLUMN     "freeShippingMessage" TEXT,
...
-- AlterTable
ALTER TABLE "State" ALTER COLUMN "id" SET DEFAULT 'state_' || substr(gen_random_uuid()::text, 1, 8);
